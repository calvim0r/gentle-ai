...
func TestNormalizeInstallFlagsDefaults(t *testing.T) {
	...
	want := model.Selection{
		Agents:  []model.AgentID{model.AgentClaudeCode, model.AgentOpenCode, model.AgentGeminiCLI, model.AgentCodex, model.AgentCursor, model.AgentVSCodeCopilot, model.AgentKiro},
...
// TestDefaultAgentsFromDetection_AllSixAgentsMappedCorrectly verifies every
...
// consumer switch.
func TestDefaultAgentsFromDetection_AllSixAgentsMappedCorrectly(t *testing.T) {
	tests := []struct {
		configAgent string
